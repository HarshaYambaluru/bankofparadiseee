...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.3/html2pdf.bundle.min.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="./customer_dashboard.css">

</head>
<body style="display: flex; flex-direction: column; justify-content:center;">
<div class = "container"> 
    <h1>Welcome <%= session.getAttribute("accountNo") %> to  BANK OF PARADISE</h1>
...
<script>
 ...
 function sortTable() {
    ...
    // Adjust logout function as before
     ...
     <!-- Footer -->
<div class="footer">
    <p>&copy; 2024 All rights reserved by Harsha</p>
</div>
